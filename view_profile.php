...
//$fname=$row['firstname'];
 ...
 $occupationdescr = isset($row['occupation_descr']) ? $row['occupation_descr'] : "";
...
if($result2){
	$row2=mysqli_fetch_array($result2);
	 $pic1 = isset($row2['pic1']) ? $row2['pic1'] : "";
	  $pic2 = isset($row2['pic2']) ? $row2['pic2'] : "";
	   $pic3 = isset($row2['pic3']) ? $row2['pic3'] : "";
	    $pic4 = isset($row2['pic4']) ? $row2['pic4'] : "";
	// $pic1=$row2['pic1'];
	// $pic2=$row2['pic2'];
	// $pic3=$row2['pic3'];
	// $pic4=$row2['pic4'];
