 ...
 <!-- create form start service start code hema -->
   <div class="services">
			         ...
			         <div class="col-sm-4 form_box">
	                  <div class="select-block1">
	                    <select name="religion">
		                    ...
		                    <option value="Hindu">Aggarwal</option>		               
		                    <option value="Jain">Other</option>
...
<option value="Tingal/Tunghal">Tingal/Tunghal</option>
      ...
      <!--      <div class="form-group col-sm-2">
          ...
          <div class="form-group col-sm-3">
		    ...
		    <div class="form-group">
		    	<label for="about me">About Candidata<span class="form-required" title="This field is required.">*</span></label>
 ...
 <!-- create form start service end code hema -->